...
const Login = () => {
    return(
        <div className="px-8 py-12 bg-white rounded-lg w-[31.25rem] shadow-md">
            ...
            <p className="text-sm text-gray-600 text-center mt-8">Don't have an account? <Link to={ '/admin/register' } className="inline-block text-primary font-semibold underline cursor-pointer">Create One</Link></p>
        </div>
    )
}
